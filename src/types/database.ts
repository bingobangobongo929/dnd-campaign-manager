    ...
    Tables: {
      ...
      intelligence_suggestions: {
        Row: {
          ...
          suggestion_type: 'status_change' | 'secret_revealed' | 'story_hook' | 'quote' | 'important_person' | 'relationship' | 'timeline_event' | 'completeness' | 'consistency' | 'npc_detected' | 'location_detected' | 'quest_detected' | 'encounter_detected' | 'plot_hook' | 'enrichment' | 'timeline_issue' | 'summary'
          field_name: string
...
export interface PinnedReference {
  entity_type: 'character' | 'npc' | 'location' | 'lore' | 'faction' | 'note' | 'quest' | 'encounter'
  entity_id: string
  label: string
}
