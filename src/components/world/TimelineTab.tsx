...
import { useSupabase, usePermissions } from '@/hooks'
import { getInitials, cn } from '@/lib/utils'
import Image from 'next/image'
import type { Character, Tag, CharacterTag, Session, CampaignEra } from '@/types/database'
...
export function TimelineTab({ campaignId, characters, isDm }: TimelineTabProps) {
  const router = useRouter()
  const supabase = useSupabase()
  const { can } = usePermissions(campaignId)
  ...
  }, [supabase, campaignId, characters, hasLoadedOnce])
