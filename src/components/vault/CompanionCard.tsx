      ...
      <div className="flex items-center gap-2">
        ...
        {companion.related_image_url ? (
          <div className="relative group/avatar">
            ...
            <div className="hidden md:block absolute bottom-full left-0 mb-2 opacity-0 group-hover/avatar:opacity-100 transition-opacity duration-200 z-50 pointer-events-none">
              <Image
                src={companion.related_image_url}
                alt={companion.related_name || 'Companion'}
                width={192}
